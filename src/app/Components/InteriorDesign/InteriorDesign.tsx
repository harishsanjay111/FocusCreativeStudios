...
export const InteriorDesign = (props: Gallery21Props) => {
            ...
            {images.map((image, index) => (
              <CarouselItem key={`${image.src}-${index}`} className="basis-auto pr-2 md:pr-4">
                <img
                  src={image.src}
                  alt={image.alt}
                  className="w-[314px] sm:w-[408px] md:w-[314px] lg:w-[408px] xxl:w-[00px]"
                />
              </CarouselItem>
            ))}
          </CarouselContent>
...
export const Gallery21DefaultProps: Gallery21Props = {
