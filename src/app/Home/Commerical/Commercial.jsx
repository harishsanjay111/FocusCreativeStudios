...
const Layout92Defaults = {
  heading: "Commercial Events",
  description:
    "Ignite your brand's presence with our dynamic commercial teasers and videos. From product launches to promotional campaigns, we specialize in crafting compelling narratives that captivate your audience. With a blend of creativity and strategy, we'll showcase your brand's story in a way that drives engagement and leaves a lasting impression on viewers.",
  image: {
    src: "Commerical.png",
    alt: "Placeholder image",
  },
  video: "https://www.youtube.com/embed/9bwOvoOB2XY?si=f4r7feUXuLnKec4_",
};
  ...
  return (
    ...
    <section className="px-[5%] py-16 md:py-24 lg:py-28">
      <div className="container mb-12 grid grid-cols-1 items-start justify-between gap-x-12 gap-y-8 md:mb-18 md:grid-cols-2 md:gap-x-12 md:gap-y-8 lg:mb-20 lg:gap-x-20">
        <h3 className="text-4xl font-bold leading-[1.2] md:text-5xl max-[768px]:text-[20px] max-[768px]:text-center lg:text-3xl wedding-heading">{heading}</h3>
